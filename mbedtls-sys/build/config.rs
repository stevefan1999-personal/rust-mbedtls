...
const DEFAULT_DEFINES: &'static [CDefine] = &[
    ...
    ("MBEDTLS_PLATFORM_MS_TIME_ALT",                      Undefined),
    ...
    ("MBEDTLS_SHA256_USE_A64_CRYPTO_IF_PRESENT",          Undefined),
    ("MBEDTLS_SHA256_USE_A64_CRYPTO_ONLY",                Undefined),
    ("MBEDTLS_SHA384_C",                                  Defined),
    ("MBEDTLS_SHA512_C",                                  Defined),
    ("MBEDTLS_SHA512_USE_A64_CRYPTO_IF_PRESENT",          Undefined),
    ("MBEDTLS_SHA512_USE_A64_CRYPTO_ONLY",                Undefined),
    ...
    ("MBEDTLS_MPI_WINDOW_SIZE",                           Undefined), // default: 2
    ...
    ("MBEDTLS_PLATFORM_STD_SETBUF",                       Undefined), // default: setbuf
    ...
    ("MBEDTLS_PLATFORM_MS_TIME_TYPE_MACRO",               Undefined), // default: int64_t
    ("MBEDTLS_PRINTF_MS_TIME",                            Undefined), // default: PRId64
    ("MBEDTLS_CHECK_RETURN",                              Undefined), // default: __attribute__
    ("MBEDTLS_PSA_HMAC_DRBG_MD_TYPE",                     Undefined), // default: MBEDTLS_MD_SHA256
